...
<li class="nav-item"><a class="nav-link" href="{{ route('admin.blades.index') }}">
    <svg class="nav-icon">
        <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-pencil"></use>
    </svg> Blades</a>
</li>
...
<li class="nav-item"><a class="nav-link" href="{{ route('admin.neighborhoods.index') }}">
    <svg class="nav-icon">
        <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-pencil"></use>
    </svg> Neighborhoods</a>
</li>
