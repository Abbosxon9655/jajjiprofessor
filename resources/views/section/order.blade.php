                ...
                <div class="card border-0">
                    ...
                    <div class="card-body rounded-bottom bg-primary p-5">
                        ...
                        <form action="/store" method="POST">
                            ...
                            <div class="form-group">
                                <input type="phone" name="phone" class="form-control border-0 p-4" placeholder="Telefon raqamingiz" required="required" />
                            </div>
                            <div class="form-group">
                                <input type="email" name="email" class="form-control border-0 p-4" placeholder="emial" required="required" />
                            </div>
                            <div class="form-group">
